...
namespace ConstructCoAPI.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(ConstructCoDbContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Employees
        [HttpGet]
        public async Task<ActionResult<ApiResult<Employee>>> GetEmployees(
           int pageIndex = 0,
           int pageSize = 10,
    ...
    [HttpGet("{id}")]
        ...
        public bool IsDupeEmployee(Employee employee)
        {
          return _context.Employees.Any(
          e => e.FirstName == employee. FirstName
          && e.LastName == employee.LastName
          && e.Initials == employee.Initials
          && e.HiredDate == employee.HiredDate
          && e.JobId == employee.JobId
          && e.YearsOfService == employee.YearsOfService
